...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_SPECIAL] = LAYOUT_split_3x5_3(
		...
		KC_GRV,  KC_TILD, KC_LCBR, KC_RCBR, KC_BTN1,   	KC_PLUS, KC_MINS, KC_SLSH, KC_DQT, KC_QUOT,
		KC_PIPE, KC_TRNS, KC_LBRC, KC_RBRC, KC_BTN2,   	KC_UNDS, KC_EQL,  KC_COMM, KC_DOT,  KC_MINS,
						  CMB_TOG, KC_SCLN, KC_EQL,    	KC_EQL,  KC_TRNS, KC_DEL),
